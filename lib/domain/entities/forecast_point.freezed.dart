...
abstract class $ForecastPointCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {DateTime date, double predictedSpend, bool risky, String? riskReason});
}
...
class _$ForecastPointImpl implements _ForecastPoint {
  ...
  @override
  String toString() {
    return 'ForecastPoint(date: $date, predictedSpend: $predictedSpend, risky: $risky, riskReason: $riskReason)';
  }
...
abstract class _ForecastPoint implements ForecastPoint {
  const factory _ForecastPoint(
      ...
      final String? riskReason}) = _$ForecastPointImpl;
