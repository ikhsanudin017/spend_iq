...
class _$UserImpl extends _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, displayName: $displayName, photoUrl: $photoUrl, phoneNumber: $phoneNumber, createdAt: $createdAt, lastLoginAt: $lastLoginAt, hasCompletedOnboarding: $hasCompletedOnboarding)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, email, displayName, photoUrl,
      phoneNumber, createdAt, lastLoginAt, hasCompletedOnboarding);
...
abstract class _User extends User {
  const factory _User(
      ...
      final DateTime? lastLoginAt,
      final bool hasCompletedOnboarding}) = _$UserImpl;
