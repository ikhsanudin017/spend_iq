...
/// Script to generate the Spend-IQ app icon (blue-only, no green/teal) as a PNG.
/// Usage: dart scripts/generate_logo_no_green.dart
Future<void> main() async {
  const size = 1024.0;
  final bytes = await _generateLogo(size);

  final file = File('assets/images/logo_spend_iq_no_green.png');
  await file.writeAsBytes(bytes);

  stdout
    ..writeln('Blue-only logo generated successfully!')
